package EveChatRoomPrj.src.ch.fhnw.kvan.chat.socket.client;
...
import EveChatRoomPrj.src.ch.fhnw.kvan.chat.interfaces.IChatRoom;
import EveChatRoomPrj.src.ch.fhnw.kvan.chat.gui.ClientGUI;
import EveChatRoomPrj.src.ch.fhnw.kvan.chat.utils.In;
import EveChatRoomPrj.src.ch.fhnw.kvan.chat.utils.Out;
 ...
 * @version
 */
public class Client implements EveChatRoomPrj.src.ch.fhnw.kvan.chat.interfaces.IChatDriver,
EveChatRoomPrj.src.ch.fhnw.kvan.chat.interfaces.IChatRoom {
	// name of the client
