	...
	public void run() {
		...
		while (true) {
			for (int i = 0; i < connections.size(); ++i) {
				//�berpr�fe bei jedem i: muss etwas aktualisiert werden? (message abholen)
				//etwas: Gespr�chsthemenliste, Teilnehmerliste
				//�nderungen: Thema add/remove; Client login/logout --> Nachricht an alle
